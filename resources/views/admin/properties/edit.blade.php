                            ...
                            <label class="label">
                                ...
                                <select name="type" class="select2">
                                    ...
                                    <optgroup label="Comercial/Industrial">
                                        <option value="commercial_room" {{ (old('type') == 'commercial_room' ? 'selected' : ($property->type == 'room' ? 'selected' : '' )) }} >Sala Comercial</option>
                                        <option value="deposit_shed" {{ (old('type') == 'deposit_shed' ? 'selected' : ($property->type == 'shed' ? 'selected' : '' )) }} >Depósito/Galpão</option>
                                        <option value="commercial_point" {{ (old('type') == 'commercial_point' ? 'selected' : ($property->type == 'point' ? 'selected' : '' )) }} >Ponto Comercial</option>
                                    </optgroup>
