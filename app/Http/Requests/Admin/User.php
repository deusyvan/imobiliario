...
class User extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            //Existe o id e é diferente de vazio no request? Sim = atualizando e desprezando o registro de id, Não = aplica o filtro normamente validando se já existe no banco de dados
            ...
            // Access
            //Existe o id e é diferente de vazio no request? Sim = atualizando e desprezando o registro de email, Não = aplica o filtro normamente validando se já existe no banco de dados
